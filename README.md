...
Seventh part of a jupyter notebook lecture series, held on 09.12.2022.

Find the rendered HTML slides [here](https://aoeftiger.github.io/TUDa-NMAP-07/).
...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/aoeftiger/TUDa-NMAP-07/v1.0)
...
``` bash
wget https://github.com/aoeftiger/TUDa-NMAP-07/archive/refs/heads/main.zip
unzip main.zip
cd TUDa-NMAP-07-main
```
